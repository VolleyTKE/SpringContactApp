...
import com.cvg.capp.rm.ContactRowMapper;
...
public class ContactDAOImpl extends BaseDAO implements ContactDAO {
    ...
    public void save(Contact c) {
        ...
        String sql = "INSERT INTO contact (userId, name, email, phone, address, remark)"
                + " VALUES(:userId, :name, :email, :phone, :address, :remark)";
    ...
    public void update(Contact c) {
        String sql = "UPDATE contact SET"
                + " name=:name, phone=:phone, userId=:userId,"
